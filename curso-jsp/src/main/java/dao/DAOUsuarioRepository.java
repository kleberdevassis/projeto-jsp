...
public BeanDtoGraficoSalarioUser montarGraficoMediaSalario(Long userLogado, String dataInicial, String dataFinal) throws Exception {
     ...
     //Date valor formatado para o banco que foi formatado do que foi digitado no parametro
	...
	public ModelLogin gravarUsuario(ModelLogin objeto, Long userLogado) throws Exception {
		...
		preparedSql.setDate(14, new Date(objeto.getDataNascimento().getTime()));
		...
		connection.commit();
			...
			prepareSql.setDate(13, new Date(objeto.getDataNascimento().getTime()));
